...
const Thumbnail = forwardRef(({ result }, ref) => {
    const BASE_URL = 'https://image.tmdb.org/t/p/original/'; {/* cela évite de taper toute l'url dans src */}
    return (
        <div
            ref={ref}
        ...
        ease-in transform sm:hover:scale-105 hover:z-50">
            ...
            <div className="p-2">
                ...
                <p className="flex items-center opacity-0 group-hover:opacity-100">
                    ...
                    <ThumbUpIcon className="h-5 mx-2" /> {result.vote_count} {/* pour avoir le nombre de likes */}
                </p>
            </div>
        </div>
    );
